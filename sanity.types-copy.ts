...
// Query: *[_type == "startup" && defined(slug.current)] | order(_createdAt desc){  _id,  title,  _createdAt,  author -> {    _id, name, image, bio  },   views,  description,  category,  image}

export type Startup_Query = {
  _id: string;
  title: string | null;
  _createdAt: string;
  author: {
...
export type STARTUP_QUERYResult = Array<Startup_Query>;
